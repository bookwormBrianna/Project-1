// a fuction to get the quiz answers
function submitQuiz() {
...
// make variables for the correct answers
var correct1 = "a";
var correct2 = "c";
var correct3 = "b";
var correct4 = "a";
...
// make an array for the correct answers
...
// create variables for the answer values, to compare the answers to the user, and to set a variable so the correct number of answers can be calculated
var answerValues = [];
var answerCompare = [];
var correctCount = 0;
...
// write to the screen the quizResponse (paired with HTML) answers and the correct answers for comparison using var answerValues
document.querySelector(".quizResponse").innerHTML = "Your Answers: " + answerValues + "</br> Correct Answers: a, c, b, a, d, b, a, c, b, d, c";

// write to the screen the correct number of answers with quizFeedback from HTML and the var correctCount
document.querySelector(".quizFeedBack").innerHTML = "You got: " + correctCount + " right out of 11";

				

	} else {
// write a response for if the user doesn't answer any or all of the questions
